onload = () => {
  ...
  const projectName = $util.getItem('projectName')
...
const onCreateTemplate = () => {
  ...
  var selectEles = document.getElementById('selectLeo');
  var selectLeo = selectEles.options[selectEles.selectedIndex].value;
  ...
  $util.setItem('selectLeo',selectLeo)
