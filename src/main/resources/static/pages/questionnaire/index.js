        ...
        $('#content').append(`
          <div class="list">
            <div class="list-header">
              ...
              <div>
                <button type="button" class="btn btn-link" onclick="onCreateQuestionnaire('${item.projectName}','${item.id}')">创建问卷</button>
                ...
                <button type="button" class="btn btn-link" onclick="onAnalyseProject('${item.id}')">统计</button>
              </div>
            </div>
...
const onAnalyseProject = (id) => {
  $util.setPageParam('seeProject', id)
  location.href = "/pages/allAnswerResults/index.html"
}
